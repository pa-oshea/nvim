...
km.nkeymap("<leader>s", ":%s/\\<<C-r><C-w>\\>/<C-r><C-w>/gI<Left><Left><Left>", "Find and replace selected")
...
-- Neo-tree
km.nkeymap("<leader>e", "<cmd>Neotree toggle<cr>", "Open neo tree")
-- TODO check out https://github.com/nvim-neo-tree/neo-tree.nvim#git_status

-- Zen mode
km.nkeymap("<leader>z", "<cmd>ZenMode<cr>", "Toggle zen mode")
