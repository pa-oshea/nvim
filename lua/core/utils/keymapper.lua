...
-- @param cmd function | string
-- @param desc? string
M.vkeymap = function(kb, cmd, desc)
	M.keymap("v", kb, cmd, desc)
end
...
-- @param cmd function | string
-- @param desc? string
M.xkeymap = function(kb, cmd, desc)
	M.keymap("x", kb, cmd, desc)
end
...
-- @param cmd function | string
-- @param desc? string
M.ikeymap = function(kb, cmd, desc)
	M.keymap("i", kb, cmd, desc)
end
...
-- @param cmd function | string
-- @param desc? string
M.nkeymap = function(kb, cmd, desc)
	M.keymap("n", kb, cmd, desc)
end
...
-- @param cmd function | string
-- @param desc? string
M.tkeymap = function(kb, cmd, desc)
	M.keymap("t", kb, cmd, desc)
end
...
M.create_bufkeymapper = function(bufnr)
	...
	-- @param cmd function | string
	-- @param desc? string
	bm.vkeymap = function(kb, cmd, desc)
		bm.keymap("v", kb, cmd, desc)
	end
	...
	-- @param cmd function | string
	-- @param desc? string
	bm.xkeymap = function(kb, cmd, desc)
		bm.keymap("x", kb, cmd, desc)
	end
	...
	-- @param cmd function | string
	-- @param desc? string
	bm.ikeymap = function(kb, cmd, desc)
		bm.keymap("i", kb, cmd, desc)
	end
	...
	-- @param cmd function | string
	-- @param desc? string
	bm.nkeymap = function(kb, cmd, desc)
		bm.keymap("n", kb, cmd, desc)
	end
	...
	-- @param cmd function | string
	-- @param desc? string
	bm.tkeymap = function(kb, cmd, desc)
		bm.keymap("t", kb, cmd, desc)
	end
